...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="entri_order.php" class="visible-phone"><i class="icon icon-bar-chart"></i> <span>Data Prospek</span></a>
  <ul>
    <?php
    if($r['id_level'] == 1){
  ?>
    ...
    <li class="active"> <a href="data_prospek.php"><i class="icon icon-bar-chart"></i> <span>Data Prospek</span></a> </li><i class="icon icon-angle-right"></i></a> </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="entri_order.php" title="Go to here" class="tip-bottom"><i class="icon icon-bar-chart"></i> Data Prospek</a></div>
  </div>

              
                <?php
                  $query_data_data = "select * from tb_belum";
          ...
          <table id="datatables" class="display">
                ...
                <?php
                  if(isset($_POST['minat'])){
                    ...
                    //echo $id_data;
                    $query_minat = "insert into tb_minat (id_minat,notas,penpok,thp,nama_penerima,tgl_lahir_penerima,thn_skr,usia,alamat_peserta,kelurahan,kecamatan,kota,nmkanbyr,tmtpensiun,nomor_skep,telepon,awal_flag,akhir_flag)select id_belum,notas,penpok,thp,nama_penerima,tgl_lahir_penerima,thn_skr,usia,alamat_peserta,kelurahan,kecamatan,kota,nmkanbyr,tmtpensiun,nomor_skep,telepon,awal_flag,akhir_flaga from tb_belum where id_belum = $id_belum";
                    $sql_minat = mysqli_query($conn, $query_minat );
                    $query_minat = "delete from tb_belum where id_belum = $id_belum";
                    $sql_minat = mysqli_query($conn, $query_minat);
                    if($sql_minat){
                      header('location: data_prospek.php');
