...
<!--Header-part-->
<div id="header">
  <h1><a href="entri_order.php">Reject</a></h1>
</div>
<!--close-Header-part--> 
...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="reject.php" class="visible-phone"><i class="icon icon-asterisk"></i> <span>Reject</span></a>
  <ul>
    <?php
    if($r['id_level'] == 1){
  ?>
  ...
  <li> <a href="approve.php"><i class="icon icon-check"></i> <span>Approve</span></a> </li>
  <li class="active"> <a href="reject.php"><i class="icon icon-asterisk"></i> <span>Reject</span></a> </l>
  ...
  <?php
    ...
    <li> <a href="database.php"><i class="icon icon-print"></i> <span>Database</span></a> </li>
    <li> <a href="report.php"><i class="icon icon-print"></i> <span>Report</span><i class="icon icon-angle-right"></i></a> </li>
    <li class="active"> <a href="approve.php"><i class="icon icon-bar-chart"></i> <span>Hasil Kunjungan</span></a> </li><i class="icon icon-angle-down"></i></a> </li>   <li> <a href="approve.php"><i class="icon icon-check"></i> <span>Approve</span></a> </li>   <li class="active"> <a href="reject.php"><i class="icon icon-asterisk"></i> <span>Reject</span></a> </li>
    <?php
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="entri_order.php" title="Go to here" class="tip-bottom"><i class="icon icon-asterisk"></i> Reject</a></div>
  </div>
 
            
                <?php
                  $query_data_data = "select * from tb_reject";
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr class="odd gradeX">
                          ...
                          <td>
                              <a href="" class="btn btn-success" data-toggle="modal" data-target="#modal<?php echo $r_dt_data['id_reject']; ?>"> <i class='icon icon-file'></i></a>
                              <div class="modal fade" id="modal<?php echo $r_dt_data['id_reject']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel"aria-hidden="true">
