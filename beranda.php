...
if(isset ($_SESSION['username'])){
  ...
  $result_db = mysqli_fetch_array($sql_jml_db);
   ...
   //Jumlah Approve
  $query_jml_app = "select count(*) AS jumlah_app from tb_approve";
  $sql_jml_app = mysqli_query($conn, $query_jml_app);
  $result_app = mysqli_fetch_array($sql_jml_app);
  
  //Jumlah Reject
  $query_jml_rej = "select count(*) AS jumlah_rej from tb_reject";
  $sql_jml_rej = mysqli_query($conn, $query_jml_rej);
  $result_rej = mysqli_fetch_array($sql_jml_rej);

  //Jumlah 1
  $query_jml_1 = "select count(*) AS jumlah_1 from tb_1";
  $sql_jml_1 = mysqli_query($conn, $query_jml_1);
  $result_1 = mysqli_fetch_array($sql_jml_1);
...
<div id="sidebar"><a href="beranda.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  ...
  ?>
    ...
    <li> <a href="approve.php"><i class="icon icon-list-alt"></i> <span>Hasil Kunjungan</span><i class="icon icon-angle-right"></i></a> </li>
     <?php
    } else if($r['id_user'] == 138 ){
    ?>
    <li class="active"><a href="beranda.php"><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>
    <li> <a href="sharedata_135.php"><i class="icon icon-cloud-upload"></i> <span>Share Data</span></a> </li>
    <li> <a href="input_data.php"><i class="icon icon-plus"></i> <span>Tambah Data Pengajuan</span></a> </li>
    <li> <a href="monitoring.php"><i class="icon icon-desktop"></i> <span>Monitoring</span></a> </li>
    <li> <a href="database.php"><i class="icon icon-print"></i> <span>Database</span></a> </li>
    <li> <a href="report.php"><i class="icon icon-print"></i> <span>Report</span><i class="icon icon-angle-right"></i></a> </li>
            ...
            <div class="span7">
              ...
              <div class="widget-content nopadding">
                  <ul class="site-stats quick-actions">
                    <li class="bg_ls"><i class="icon-folder-open"></i> <strong><?php echo $result_mnt['jumlah_mnt']+$result_blm['jumlah_blm']+$result_ln['jumlah_ln']; ?></strong> <small>Dikunjungi</small></li>
                    <li class="bg_ly"><i class="icon-tasks"></i> <strong><?php echo $result_db['jumlah_db']; ?></strong> <small>Belum Dikunjungi</small></li>
                    <li class="bg_lg"><i class="icon-book"></i> <strong><?php echo $result_app['jumlah_app']+$result_rej['jumlah_rej']; ?></strong> <small>Report</small></li>
                  </ul>
                </div>
              </div>
            </div>
       ...
       <div class="widget-content" >
          ...
          <div class="span7">
            ...
            <div class="widget-content nopadding">
                <ul class="site-stats quick-actions">
                   <li class="bg_ls"><i class="icon-folder-open"></i> <strong><?php echo $result_mnt['jumlah_mnt']+$result_blm['jumlah_blm']+$result_ln['jumlah_ln']; ?></strong> <small>Dikunjungi</small></li>
                    <li class="bg_ly"><i class="icon-tasks"></i> <strong><?php echo $result_1['jumlah_1']; ?></strong> <small>Belum Dikunjungi</small></li>
                    <li class="bg_lg"><i class="icon-book"></i> <strong><?php echo $result_app['jumlah_app']+$result_rej['jumlah_rej']; ?></strong> <small>Report</small></li>
                </ul>
              </div>
            </div>
       ...
       <div class="widget-content" >
          ...
          <div class="span7">
            ...
            <div class="widget-content nopadding">
                <ul class="site-stats quick-actions">
                <li class="bg_ls"><i class="icon-folder-open"></i> <strong><?php echo $result_mnt['jumlah_mnt']+$result_blm['jumlah_blm']+$result_ln['jumlah_ln']; ?></strong> <small>Dikunjungi</small></li>
                    <li class="bg_ly"><i class="icon-tasks"></i> <strong><?php echo $result_2['jumlah_2']; ?></strong> <small>Belum Dikunjungi</small></li>
                    <li class="bg_lg"><i class="icon-book"></i> <strong><?php echo $result_app['jumlah_app']+$result_rej['jumlah_rej']; ?></strong> <small>Report</small></li>
                </ul>
                </ul>
              </div>
          ...
          <div class="span7">
            ...
            <div class="widget-content nopadding">
                <ul class="site-stats quick-actions">
                  ...
                  <li class="bg_ly"><i class="icon-tasks"></i> <strong><?php echo $result_dbso['jumlah_dbso']; ?></strong> <small>Belum Dikunjungi</small></li>
