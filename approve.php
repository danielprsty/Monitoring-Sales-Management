...
<!--Header-part-->
<div id="header">
  <h1><a href="entri_order.php">Approve</a></h1>
</div>
<!--close-Header-part--> 
...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="approve.php" class="visible-phone"><i class="icon icon-check"></i> <span>Approve</span></a>
  <ul>
    <?php
    if($r['id_level'] == 1){
  ?>
  ...
  <li class="active"> <a href="approve.php"><i class="icon icon-bar-chart"></i> <span>Hasil Kunjungan</span></a> </li><i class="icon icon-angle-down"></i></a> </li>
  <li class="active"> <a href="approve.php"><i class="icon icon-check"></i> <span>Approve</span></a> </li>
  <li> <a href="reject.php"><i class="icon icon-asterisk"></i> <span>Reject</span></a> </l>
  ...
  <?php
    ...
    <li> <a href="database.php"><i class="icon icon-print"></i> <span>Database</span></a> </li>
    <li> <a href="report.php"><i class="icon icon-print"></i> <span>Report</span><i class="icon icon-angle-right"></i></a> </li>
    <li class="active"> <a href="approve.php"><i class="icon icon-bar-chart"></i> <span>Hasil Kunjungan</span></a> </li><i class="icon icon-angle-down"></i></a> </li>   <li class="active"> <a href="approve.php"><i class="icon icon-check"></i> <span>Approve</span></a> </li>   <li> <a href="reject.php"><i class="icon icon-asterisk"></i> <span>Reject</span></a> </l>
    <?php
   ...
   <li> <a href="database.php"><i class="icon icon-print"></i> <span>Database</span></a> </li>
    <li> <a href="report.php"><i class="icon icon-print"></i> <span>Report</span><i class="icon icon-angle-right"></i></a> </li>
    <li class="active"> <a href="approve.php"><i class="icon icon-bar-chart"></i> <span>Hasil Kunjungan</span></a> </li><i class="icon icon-angle-down"></i></a> </li>   <li class="active"> <a href="approve.php"><i class="icon icon-check"></i> <span>Approve</span></a> </li>   <li> <a href="reject.php"><i class="icon icon-asterisk"></i> <span>Reject</span></a> </li>
      <?php
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="entri_order.php" title="Go to here" class="tip-bottom"><i class="icon icon-bar-chart"></i> Approve</a></div>
  </div>
              
                <?php
                  $query_data_data = "select * from tb_approve";
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr class="odd gradeX">
                          ...
                          <td>
                              <a href="" class="btn btn-success" data-toggle="modal" data-target="#modal<?php echo $r_dt_data['id_approve']; ?>"> <i class='icon icon-file'></i></a>
                              <div class="modal fade" id="modal<?php echo $r_dt_data['id_approve']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel"aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <form>
                             <div class="form-group">
                                <h5 for="exampleFormControlTextarea1">NAMA : 
                                </h5>
                                 <div class="form-group">
                                     <?php echo $r_dt_data['nama_penerima']; ?>
                            </div>
                        <div class="form-group">
                                <h5 for="exampleFormControlTextarea1">NOTAS :
                                </h5>
                                <div class="form-group">
                                    <?php echo $r_dt_data['notas']; ?> 
        </div>
        </div>
                        <div class="form-group">
                                <h5 for="exampleFormControlTextarea1">PENGHASILAN POKOK : 
                                </h5>
                                 <div class="form-group">
                                     <?php echo $r_dt_data['penpok']; ?>
                            </div>
        </div>
                            <div class="form-group">
                                <h5 for="exampleFormControlTextarea1">THP : 
                                </h5>
                                 <div class="form-group">
                                     <?php echo $r_dt_data['thp']; ?>
                            </div>
                             
                              <div class="form-group">
                                <h5 for="exampleFormControlTextarea1">TANGGAL LAHIR : 
                                </h5>
                                 <div class="form-group">
                                     <?php echo $r_dt_data['tgl_lahir_penerima']; ?>
                            </div>
                             <div class="form-group">
                                <h5 for="exampleFormControlTextarea1">TAHUN SKR : 
                                </h5>
                                 <div class="form-group">
                                     <?php echo $r_dt_data['thn_skr']; ?>
                            </div>
                             <div class="form-group">
                                <h5 for="exampleFormControlTextarea1">USIA : 
                                </h5>
                                 <div class="form-group">
                                     <?php echo $r_dt_data['usia']; ?>
                            </div>
                             <div class="form-group">
                                <h5 for="exampleFormControlTextarea1">ALAMAT : 
                                </h5>
                                 <div class="form-group">
                                     <?php echo $r_dt_data['alamat_peserta']; ?>
                            </div>
                             <div class="form-group">
                                <h5 for="exampleFormControlTextarea1">KOTA : 
                                </h5>
                                 <div class="form-group">
                                     <?php echo $r_dt_data['kota']; ?>
                            </div>
                             <div class="form-group">
                                <h5 for="exampleFormControlTextarea1">KECAMATAN : 
                                </h5>
                                 <div class="form-group">
                                     <?php echo $r_dt_data['kecamatan']; ?>
                            </div>
                             <div class="form-group">
                                <h5 for="exampleFormControlTextarea1">KELURAHAN : 
                                </h5>
                                 <div class="form-group">
                                     <?php echo $r_dt_data['kelurahan']; ?>
                            </div>
                             <div class="form-group">
                                <h5 for="exampleFormControlTextarea1">KANTOR BAYAR : 
                                </h5>
                                 <div class="form-group">
                                     <?php echo $r_dt_data['nmkanbyr']; ?>
                            </div>
                             <div class="form-group">
                                <h5 for="exampleFormControlTextarea1">TAMAT PENSIUN : 
                                </h5>
                                 <div class="form-group">
                                     <?php echo $r_dt_data['tmtpensiun']; ?>
                            </div>
                             <div class="form-group">
                                <h5 for="exampleFormControlTextarea1">NOMOR SKEP : 
                                </h5>
                                 <div class="form-group">
                                     <?php echo $r_dt_data['nomor_skep']; ?>
                            </div>
                             <div class="form-group">
                                <h5 for="exampleFormControlTextarea1">NO.TELP : 
                                </h5>
                                 <div class="form-group">
                                     <?php echo $r_dt_data['telepon']; ?>
                            </div>
                             <div class="form-group">
                                <h5 for="exampleFormControlTextarea1">AWAL FLAG : 
                                </h5>
                                 <div class="form-group">
                                     <?php echo $r_dt_data['awal_flag']; ?>
                            </div>
                             <div class="form-group">
                                <h5 for="exampleFormControlTextarea1">AKHIR FLAG : 
                                </h5>
                                 <div class="form-group">
                                     <?php echo $r_dt_data['akhir_flag']; ?>
                            </div>
                        </form>
                    </div>
                    </div>
