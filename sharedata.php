...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="sharedata.php" class="visible-phone"><i class="icon icon-cloud-upload"></i> <span>Share Data</span></a>
  <ul>
    <?php
    if($r['id_level'] == 1){
  ?>
  ...
  ?>
    ...
    <li> <a href="input_mrtl.php"><i class="icon icon-inbox"></i> <span>Input SO/TL</span></a> </li>
    <li> <a href="daftar_mrtl.php"><i class="icon icon-tasks"></i> <span>Daftar SO/TL</span></a> </li>
    <li> <a href="database_tl.php"><i class="icon icon-print"></i> <span>Database</span></a> </li>
    <li> <a href="report.php"><i class="icon icon-print"></i> <span>Report</span><i class="icon icon-angle-right"></i></a> </li>
  <?php
    } else if($r['id_level'] == 4|| $r['id_level'] == 5 || $r['id_level'] == 6 || $r['id_level'] == 7 || $r['id_level'] == 8 || $r['id_level'] == 9 || $r['id_level'] == 10 || $r['id_level'] == 11 || $r['id_level'] == 12 || $r['id_level'] == 13|| $r['id_level'] == 14|| $r['id_level'] == 15|| $r['id_level'] == 16|| $r['id_level'] == 17|| $r['id_level'] == 18|| $r['id_level'] == 19|| $r['id_level'] == 20|| $r['id_level'] == 21|| $r['id_level'] == 21|| $r['id_level'] == 23|| $r['id_level'] == 24|| $r['id_level'] == 25|| $r['id_level'] == 26|| $r['id_level'] == 27|| $r['id_level'] == 28|| $r['id_level'] == 29|| $r['id_level'] == 30|| $r['id_level'] == 31|| $r['id_level'] == 32|| $r['id_level'] == 33|| $r['id_level'] == 34|| $r['id_level'] == 35|| $r['id_level'] == 36|| $r['id_level'] == 37|| $r['id_level'] == 38|| $r['id_level'] == 39|| $r['id_level'] == 40|| $r['id_level'] == 41|| $r['id_level'] == 42|| $r['id_level'] == 43|| $r['id_level'] == 44|| $r['id_level'] == 45|| $r['id_level'] == 46|| $r['id_level'] == 47|| $r['id_level'] == 48|| $r['id_level'] == 49|| $r['id_level'] == 50|| $r['id_level'] == 51|| $r['id_level'] == 52|| $r['id_level'] == 53  ){
  ?>
      ...
      <div class="widget-box">
        ...
        <select class=span6 name="form_database" id="form_database">
				<option value="">--Pilih Database--</option>
					...
					$sql = mysqli_query($conn, "SELECT * FROM tb_database GROUP BY keterangan ORDER by keterangan");
      ...
      <div class="widget-box">
        ...
        <table class="table table-bordered" style="width: 100%">
                    ...
                    <?php
                      ...
                      ?>
           <?php
            if (isset($_GET['form_database'],$_GET['form_kota'])) {
                $dataket=trim($_GET['form_database']);
                $datakota=trim($_GET['form_kota']);
                
                $tamPeg=mysqli_query($conn, "SELECT * FROM tb_database WHERE kota='$datakota' AND keterangan='$dataket' ORDER BY id_database DESC");
            ...
            <tbody>
                ...
                <tr>
                <td><input type="checkbox" name="kirim[]" value="<?php echo $tpeg['id_database'];?>"></td>
    ...
    <div class="span12">
        ...
        <select class=span3 name="form_so" id="form_so">
				<option value="">--Pilih SO--</option>
					...
					while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
						echo "<option value='".$data['id_sales_officer']."'>".$data['nama_sales_officer']." - ".$data['cabang']."</option>";
					}
					?>
				</select>
            <form action="" method="post">
                <button name="kirimso" value="<?php echo $tpeg['id_database']; ?>" class="btn btn-basic">Kirim</button>
              
         
        <form action="" method="post" class="form-horizontal">
        <div class="control-group">
               <label class="control-label">Kirim Ke Team Leader :</label>
              <div class="controls">
        <select class=span3 name="form_tl" id="form_tl">
				<option value="">--Pilih TL--</option>
					...
					// Buat query untuk menampilkan semua data siswa
					$sql = mysqli_query($conn, "SELECT * FROM tb_team_leader ORDER by nama_team_leader");
			
					while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
						echo "<option value='".$data['id_team_leader']."'>".$data['nama_team_leader']." - ".$data['cabang']."</option>";
					}
					?>
				</select>
            <form action="" method="post">
                <button name="kirimtl" value="<?php echo $tpeg['id_database']; ?>" class="btn btn-basic">Kirim</button>
                </div>
        </table>
        ...
        if(isset($_POST['form_so'])){
            ...
            if($datamr=="1"){
                  if(isset($_POST['kirimso']) && isset($_POST['kirim'])){
                    $id_database = $_POST['kirimso'];
                    foreach($_POST["kirim"] as $kirim){
                    $query_kirimso = "insert into tb_1 (id_1,notas,penpok,thp,nama_penerima,tgl_lahir_penerima,thn_skr,usia,alamat_peserta,keterangan,kelurahan,kecamatan,kota,nmkanbyr,tmtpensiun,nomor_skep,telepon,awal_flag,akhir_flag,thn_pens,nmsatker)select id_database,notas,penpok,thp,nama_penerima,tgl_lahir_penerima,thn_skr,usia,alamat_peserta,keterangan,kelurahan,kecamatan,kota,nmkanbyr,tmtpensiun,nomor_skep,telepon,awal_flag,akhir_flag,thn_pens,nmsatker from tb_database where id_database = $kirim";
                    $sql_kirimso = mysqli_query($conn, $query_kirimso );
                     $query_delete = "delete from tb_database where id_database = $kirim";
            ...
            if($datatl=="1"){
                  if(isset($_POST['kirimtl']) && isset($_POST['kirim'])){
                    $id_database = $_POST['kirimtl'];
                    foreach($_POST["kirim"] as $kirim){
                    $query_kirimtl = "insert into tb_51 (id_51,notas,penpok,thp,nama_penerima,tgl_lahir_penerima,thn_skr,usia,alamat_peserta,keterangan,kelurahan,kecamatan,kota,nmkanbyr,tmtpensiun,nomor_skep,telepon,awal_flag,akhir_flag,thn_pens,nmsatker)select id_database,notas,penpok,thp,nama_penerima,tgl_lahir_penerima,thn_skr,usia,alamat_peserta,keterangan,kelurahan,kecamatan,kota,nmkanbyr,tmtpensiun,nomor_skep,telepon,awal_flag,akhir_flag,thn_pens,nmsatker from tb_database where id_database = $kirim";
                  ...
                  if(isset($_POST['kirimtl']) && isset($_POST['kirim'])){
                    $id_database = $_POST['kirimtl'];
                    foreach($_POST["kirim"] as $kirim){
                    $query_kirimtl = "insert into tb_129 (id_129,notas,penpok,thp,nama_penerima,tgl_lahir_penerima,thn_skr,usia,alamat_peserta,keterangan,kelurahan,kecamatan,kota,nmkanbyr,tmtpensiun,nomor_skep,telepon,awal_flag,akhir_flag,thn_pens,nmsatker)select id_database,notas,penpok,thp,nama_penerima,tgl_lahir_penerima,thn_skr,usia,alamat_peserta,keterangan,kelurahan,kecamatan,kota,nmkanbyr,tmtpensiun,nomor_skep,telepon,awal_flag,akhir_flag,thn_pens,nmsatker from tb_database where id_database = $kirim";
                    $sql_kirimtl = mysqli_query($conn, $query_kirimtl );
                    $query_delete = "delete from tb_database where id_database = $kirim";
                    $sql_delete = mysqli_query($conn, $query_delete);
                    if($sql_delete){
                  ...
                  if(isset($_POST['kirimtl']) && isset($_POST['kirim'])){
                    $id_database = $_POST['kirimtl'];
                    foreach($_POST["kirim"] as $kirim){
                    $query_kirimtl = "insert into tb_130 (id_130,notas,penpok,thp,nama_penerima,tgl_lahir_penerima,thn_skr,usia,alamat_peserta,keterangan,kelurahan,kecamatan,kota,nmkanbyr,tmtpensiun,nomor_skep,telepon,awal_flag,akhir_flag,thn_pens,nmsatker)select id_database,notas,penpok,thp,nama_penerima,tgl_lahir_penerima,thn_skr,usia,alamat_peserta,keterangan,kelurahan,kecamatan,kota,nmkanbyr,tmtpensiun,nomor_skep,telepon,awal_flag,akhir_flag,thn_pens,nmsatker from tb_database where id_database = $kirim";
                    $sql_kirimtl = mysqli_query($conn, $query_kirimtl );
                    $query_delete = "delete from tb_database where id_database = $kirim";
                    $sql_delete = mysqli_query($conn, $query_delete);
                    if($sql_delete){
                  ...
                  if(isset($_POST['kirimtl']) && isset($_POST['kirim'])){
                    $id_database = $_POST['kirimtl'];
                    foreach($_POST["kirim"] as $kirim){
                    $query_kirimtl = "insert into tb_133 (id_133,notas,penpok,thp,nama_penerima,tgl_lahir_penerima,thn_skr,usia,alamat_peserta,keterangan,kelurahan,kecamatan,kota,nmkanbyr,tmtpensiun,nomor_skep,telepon,awal_flag,akhir_flag,thn_pens,nmsatker)select id_database,notas,penpok,thp,nama_penerima,tgl_lahir_penerima,thn_skr,usia,alamat_peserta,keterangan,kelurahan,kecamatan,kota,nmkanbyr,tmtpensiun,nomor_skep,telepon,awal_flag,akhir_flag,thn_pens,nmsatker from tb_database where id_database = $kirim";
                    $sql_kirimtl = mysqli_query($conn, $query_kirimtl );
                    $query_delete = "delete from tb_database where id_database = $kirim";
                    $sql_delete = mysqli_query($conn, $query_delete);
                    if($sql_delete){
                  ...
                  if(isset($_POST['kirimtl']) && isset($_POST['kirim'])){
                    $id_database = $_POST['kirimtl'];
                    foreach($_POST["kirim"] as $kirim){
                    $query_kirimtl = "insert into tb_134 (id_134,notas,penpok,thp,nama_penerima,tgl_lahir_penerima,thn_skr,usia,alamat_peserta,keterangan,kelurahan,kecamatan,kota,nmkanbyr,tmtpensiun,nomor_skep,telepon,awal_flag,akhir_flag,thn_pens,nmsatker)select id_database,notas,penpok,thp,nama_penerima,tgl_lahir_penerima,thn_skr,usia,alamat_peserta,keterangan,kelurahan,kecamatan,kota,nmkanbyr,tmtpensiun,nomor_skep,telepon,awal_flag,akhir_flag,thn_pens,nmsatker from tb_database where id_database = $kirim";
                    $sql_kirimtl = mysqli_query($conn, $query_kirimtl );
                    $query_delete = "delete from tb_database where id_database = $kirim";
                    $sql_delete = mysqli_query($conn, $query_delete);
                    if($sql_delete){
                    ...
                    $query_delete = "delete from tb_bup where id_bup = $kirim";
                    $sql_delete = mysqli_query($conn, $query_delete);
                    $query_delete = "delete from tb_pensiunan where id_pensiunan = $kirim";
                    $sql_delete = mysqli_query($conn, $query_delete);
                    if($sql_delete){
                      header('location: sharedata.php');}
        ?>
