...
if(isset ($_SESSION['username'])){
  ...
  //Jumlah pensiunan
  $query_jml_bup = "select count(*) AS jumlah_bup from tb_bup";
  $sql_jml_bup = mysqli_query($conn, $query_jml_bup);
  $result_bup = mysqli_fetch_array($sql_jml_bup);
...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="bup.php" class="visible-phone"><i class="icon shopping-cart"></i> <span>BUP</span></a>
  <ul>
    <?php
    if($r['id_level'] == 1){
  ?>
    ...
    <li> <a href="pensiunan.php"><i class="icon icon-suitcase"></i> <span>Pensiunan</span></a> </li>
    <li class="active"> <a href="bup.php"><i class="icon icon-suitcase"></i> <span>BUP</span></a></a> </li><i class="icon icon-angle-right"></i> </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="bup.php" title="Go to here" class="tip-bottom"><i class="icon icon-suitcase"></i> Database BUP</a></div>
  </div>
   <?php
      if($r['id_level'] == 1){
    ?>
...
$(function(){
             ...
             $('#datatables').DataTable({
              ...
              "ajax":{
                       "url": "ajax/ajax_bup.php?action=table_data",
                       "dataType": "json",
                       "type": "POST"
                     },
              "columns": [
