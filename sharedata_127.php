...
<div id="sidebar"><a href="entri_order.php" class="visible-phone"><i class="icon shopping-cart"></i> <span>ShareData</span></a>
  ...
  <?php
      ...
      ?>
    <li><a href="beranda.php"><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>
    <li class="active"> <a href="sharedata_127.php"><i class="icon icon-cloud-upload"></i> <span>Share Data</span></a> </li>
    <li> <a href="input_data.php"><i class="icon icon-plus"></i> <span>Tambah Data Pengajuan</span></a> </li>
    <li> <a href="monitoring.php"><i class="icon icon-desktop"></i> <span>Monitoring</span></a> </li>
      ...
      <div class="widget-box">
        ...
        <select class=span6 name="form_database" id="form_database">
				<option value="">--Pilih Database--</option>
					...
					$sql = mysqli_query($conn, "SELECT * FROM tb_127 GROUP BY keterangan ORDER by keterangan");
        ...
        <table class="table table-bordered" style="width: 100%">
           ...
           <?php
            if (isset($_GET['form_database'],$_GET['form_kota'], $_GET['form_kec'], $_GET['form_kel'])) {
                ...
                $tamPeg=mysqli_query($conn, "SELECT * FROM tb_127 WHERE kecamatan='$datakec' AND kota='$datakota' AND kelurahan='$datakel' AND keterangan='$dataket' ORDER BY id_127 DESC");
            ...
            <tbody>
                ...
                <tr>
                <td><input type="checkbox" name="kirim[]" value="<?php echo $tpeg['id_127'];?>"></td>
  ...
  <div class="row-fluid">
    <div class="span12">
        ...
        <select class=span3 name="form_so" id="form_so">
            ...
            <form action="" method="post">
                <button name="kirimso" value="<?php echo $tpeg['id_127']; ?>" class="btn btn-basic">Kirim</button>
                </div>
        </table>
        ...
        if(isset($_POST['form_so'])){
            ...
            if($datamr=="1"){
                  if(isset($_POST['kirimso']) && isset($_POST['kirim'])){
                    $id_127 = $_POST['kirimso'];
                    foreach($_POST["kirim"] as $kirim){
                    $query_kirimso = "insert into tb_1 (id_1,notas,penpok,thp,nama_penerima,tgl_lahir_penerima,thn_skr,usia,alamat_peserta,keterangan,kelurahan,kecamatan,kota,nmkanbyr,tmtpensiun,nomor_skep,telepon,awal_flag,akhir_flag,thn_pens,nmsatker)select id_127,notas,penpok,thp,nama_penerima,tgl_lahir_penerima,thn_skr,usia,alamat_peserta,keterangan,kelurahan,kecamatan,kota,nmkanbyr,tmtpensiun,nomor_skep,telepon,awal_flag,akhir_flag,thn_pens,nmsatker from tb_127 where id_127 = $kirim";
                    $sql_kirimso = mysqli_query($conn, $query_kirimso );
                     $query_delete = "delete from tb_127 where id_127 = $kirim";
